...
FILE* fp = fopen("D:\\tempdata\\Biomechanical Model\\figures\\flywheel_design_out.raw", "wb");
// OpenGL rendering
int refreshrate;
...
void loadmodel(GLFWwindow* window, const char* filename, const mjVFS* xmlstring)
{
...
void simulation(void)
{
    ...
    {/* legacy code from original simulate.cpp code, consider deleting
...
int main(int argc, const char** argv)
{
    ...
    int a = std::system("start python \"C:\\Users\\Radu\\Documents\\GitHub\\Proprio-Prosthetics-Model\\Flywheel Design\\src\\ServeSiteCoords.py\" &");
    int b = std::system("start python \"C:\\Users\\Radu\\Documents\\GitHub\\Proprio-Prosthetics-Model\\Flywheel Design\\src\\NeuronServer.py\" &");
	...
	joints.push_back("world_x");
	joints.push_back("world_y");
	joints.push_back("world_z");
	joints.push_back("world_xt");
	joints.push_back("world_yt");
	joints.push_back("world_zt");
