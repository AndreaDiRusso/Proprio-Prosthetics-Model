...
parser.add_argument('--modelKinematicsFile', default = 'W:/ENG_Neuromotion_Shared/group/Proprioprosthetics/Data/201709261100-Proprio/T_1_model.pickle')
...
saveName = modelKinematicsFile.split('.')[0] + "_kinetics.pickle"
